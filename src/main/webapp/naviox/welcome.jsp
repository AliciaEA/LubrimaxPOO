...
In LubrimaxPOO-labels_en.properties:
LubrimaxPOO=My application
LubrimaxPOO[description]=My application does this and that

In LubrimaxPOO-messages_en.properties:
